...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Squid 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://hub.docker.com/r/datadog/squid)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| squid | 9091 | 范例：http_proxy=http://172.17.42.1:9091 | Y |
## 文档

[Squid 管理员手册](https://support.websoft9.com/docs/squid)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Squid 企业级支持版](https://apps.websoft9.com/squid) 
