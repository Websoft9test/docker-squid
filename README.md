...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r squid
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r squid -p
```
...
#### How to enable Internet IP access this proxy?  
Need to modify configuration file `http_access deny all` to 'http_access allow all'  
...
| --- | --- | --- | --- |
| squid | 9091 | e.g http_proxy=http://172.17.42.1:9091 | Y |
## Documentation

[Squid Administrator Guide](https://support.websoft9.com/docs/squid)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Squid Enterprise Support](https://apps.websoft9.com/squid) 
